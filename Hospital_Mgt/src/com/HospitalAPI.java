...
public class HospitalAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = patObj.insertItem(request.getParameter("pName"),
				...
				request.getParameter("pRooms"),
				request.getParameter("pSpeacialty"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = patObj.updateItem(paras.get("hidItemIDSave").toString(),
		paras.get("pName").toString(),
		paras.get("pAddress").toString(),
		paras.get("pRooms").toString(),
		paras.get("pSpeacialty").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request);
		String output = patObj.deleteItem(paras.get("pID").toString());
		response.getWriter().write(output);
